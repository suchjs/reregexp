...
var RegexpSet = (function (_super) {
    ...
    RegexpSet.prototype.prebuild = function (conf) {
        ...
        if (conf.extractSetAverage) {
            var total_3 = 0;
            var totals = queues.map(function (queue) { return (total_3 = total_3 + queue.count); });
    ...
    RegexpSet.prototype.getCodePointCount = function () {
        return 1;
    };
                ...
                var ranges = queues.reduce(function (res, item) {
                    ...
                    if (type === 'charset') {
                        ...
                        if (charset === 'b' || charset === 'B') {
                            ...
                            cur = charH.getCharsetInfo(charset, flags_1).ranges;
                        }
                    }
                    else if (type === 'range') {
                        cur = [
