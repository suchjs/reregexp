        ...
        while (i < j) {
            ...
            switch (char) {
                ...
                case s.groupBegin:
                    ...
                    var curQueue = lastGroup || lastLookaround;
                    if (curQueue) {
            ...
            if (target) {
                ...
                if (curRange && curRange.isComplete === false && curRange !== target) {
                    ...
                    var curQueue = getLastItem(nestQueues).type === 'group' ? getLastItem(groups) : getLastItem(lookarounds);
                    if (curQueue !== cur) {
                        cur.parent = curQueue;
                        curQueue.add(cur);
                    }
...
var RegexpReference = (function (_super) {
    ...
    function RegexpReference(input) {
        ...
        _this.ref = null;
        _this.emptyRefFlag = false;
        _this.index = Number("" + input.slice(1));
        return _this;
    }
    Object.defineProperty(RegexpReference.prototype, "isEmptyRef", {
        get: function () {
...
var RegexpGroup = (function (_super) {
    ...
    RegexpGroup.prototype.addNewGroup = function (queue) {
        ...
        var groupItem = new RegexpGroupItem(groups.length);
        if (queue) {
            groupItem.add(queue);
        }
    ...
    RegexpGroup.prototype.setItemEmptyRef = function () {
        var _a = this, groups = _a.groups, emptyRefItems = _a.emptyRefItems;
