...
exports.RegexpGroup = exports.RegexpGroupItem = exports.RegexpASCII = exports.RegexpUnicodeAll = exports.RegexpUnicode = exports.RegexpHexCode = exports.RegexpRange = exports.RegexpSet = exports.RegexpTimesQuantifiers = exports.RegexpTimesMulti = exports.RegexpTimes = exports.RegexpRefOrNumber = exports.RegexpOctal = exports.RegexpTranslateChar = exports.RegexpChar = exports.RegexpAnchor = exports.RegexpIgnore = exports.RegexpPrint = exports.RegexpCharset = exports.RegexpControl = exports.RegexpBegin = exports.RegexpBackspace = exports.RegexpNull = exports.RegexpAny = exports.RegexpLookaround = exports.RegexpSpecial = exports.RegexpReference = exports.RegexpOrigin = exports.RegexpEmpty = exports.RegexpPart = exports.regexpRule = exports.parserRule = void 0;
    ...
    CharsetHelper.charsetOfNegated = function (type) {
        ...
        if (cache[type]) {
            ...
            if (type === 'DOTALL') {
                ...
                var total_2 = excepts.length;
                while (start <= max && total_2 > specialNum) {
                    var _a = excepts[--total_2], begin = _a[0], end = _a[1];
                    add(start, begin - 1);
                    start = (end || begin) + 1;
                }
                if (start < max) {
...
var Parser = (function () {
    ...
    Parser.prototype.build = function () {
        ...
        var nullRootError = 'the regexp has null expression, will match nothing';
    ...
    Parser.prototype.parse = function () {
        ...
        var addToGroup = function (cur) {
            if (groups.length || lookarounds.length) {
                var isGroup = (nestQueues.length && getLastItem(nestQueues).type === 'group') ||
                    groups.length > 0;
                var curQueue = isGroup
                    ? getLastItem(groups)
...
var RegexpSet = (function (_super) {
    ...
    RegexpSet.prototype.prebuild = function (conf) {
        ...
        var index = makeRandom(0, queues.length - 1);
...
var RegexpGroup = (function (_super) {
    ...
    RegexpGroup.prototype.prebuild = function (conf) {
                    ...
                    if (typeof namedGroupConf[captureName] === 'object') {
                        ...
                        segs.forEach(function (key, index) {
                            if (typeof conf_1[key] === 'boolean' && conf_1[key] === false) {
                                ...
                                lastIndexs_1.push(index);
                            }
                        });
                    }
                    if (lastIndexs_1.length) {
                        curGroups = lastIndexs_1.map(function (index) { return groups[index]; });
                    }
                    else {
        ...
        if (captureName &&
            ...
            var namedGroup = namedGroupConf[captureName];
